package com.bnneett.creategolems.animation;
...
public class BaseGolemAnimation {
	...
	public static final AnimationDefinition power_down = AnimationDefinition.Builder.withLength(1.5F)
		.addAnimation("smartgolem", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
			new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM)
		))
		.addAnimation("upperbody", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
			new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
	...
	public static final AnimationDefinition power_up = AnimationDefinition.Builder.withLength(1.5F)
		.addAnimation("smartgolem", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
			new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM)
		))
		.addAnimation("upperbody", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
		...
		public static final AnimationDefinition no_power = AnimationDefinition.Builder.withLength(4.0F).looping()
		.addAnimation("smartgolem", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
			new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
