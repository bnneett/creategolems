...
@Mod(value = CreateGolems.MODID, dist = Dist.CLIENT)
// You can use EventBusSubscriber to automatically register all static methods in the class annotated with @SubscribeEvent
@EventBusSubscriber(modid = CreateGolems.MODID, value = Dist.CLIENT)
public class CreateGolemsClient {
    public CreateGolemsClient(ModContainer container) {
    ...
    @SubscribeEvent
    public static void onRegsterRenders(EntityRenderersEvent.RegisterRenderers event) {
        event.registerEntityRenderer(
            GolemEntities.BASE_GOLEM.get(),
            BaseGolemRenderer::new
        );
    }
    ...
    public static void onRegisterLayerDefinition(EntityRenderersEvent.RegisterLayerDefinitions event) {
        event.registerLayerDefinition(
            BaseGolemModel.LAYER_LOCATION,
            BaseGolemModel::createBodyLayer
        );
    }
